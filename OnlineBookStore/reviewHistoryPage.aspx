...
<head runat="server">
    ...
    <style>
        ...
        /* [ลบ] Search Bar */
        .header-icons { display: flex; gap: 15px; font-size: 0.95rem; align-items: center; /* [เพิ่ม] align */ }
        ...
        .review-history-list { display: grid; grid-template-columns: 1fr; gap: 1.5rem; }
        .review-card { background-color: #fff; border: 1px solid #e0e0e0; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); display: flex; flex-direction: column; /* [แก้ไข] ให้เรียงแนวตั้งบนจอมือถือ */ gap: 1rem; padding: 1.5rem; }
        @media (min-width: 600px) { /* กลับมาเรียงแนวนอนบนจอใหญ่ขึ้น */
            .review-card { flex-direction: row; gap: 1.5rem; }
        }
        .review-card-cover { text-align: center; /* [เพิ่ม] จัดกลางบนจอมือถือ */ }
        .review-card-cover img { width: 100px; height: 150px; object-fit: cover; border-radius: 4px; background-color: #f4f4f4; display: inline-block; /* [เพิ่ม] ให้จัดกลางได้ */ }
        .review-card-content { flex: 1; }
        .review-card-content h3 { font-size: 1.25rem; font-weight: 600; margin-top: 0; margin-bottom: 0.5rem; }
        .review-book-details { font-size: 0.85rem; color: #444; margin-bottom: 1rem; display: flex; flex-wrap: wrap; gap: 0.5rem 1.5rem; }
        .review-book-details strong { color: #111; }
        .review-card-meta { font-size: 0.9rem; color: #555; margin-bottom: 1rem; }
        .review-card-meta .rating { font-weight: bold; color: #eab308; }
        .review-card-comment { font-size: 1rem; color: #333; line-height: 1.6; white-space: pre-wrap; margin-top: 0.5rem; /* [เพิ่ม] ระยะห่าง */ }
        ...
        <header class="top-header">
            <div class="container">
                ...
                <div class="header-icons">
                    ...
                    <%-- [แก้ไข] ไอคอนตะกร้า ให้เหมือนหน้าอื่น --%>
